...
import {getCords} from './getWallCords.js';
...
class BasicWorldDemo {
  ...
  _Initialize() {
    ...
    getCords(Wall5);
     ...
     // FIVE AS IN LIKE 55555
     const Wall55 = new THREE.Mesh(
      new THREE.BoxGeometry(10, 200, 10),
      new THREE.MeshStandardMaterial({
          color: 0x008000,
      }));
    Wall55.position.set(5, 100, 250);
    Wall55.castShadow = true;
    Wall55.receiveShadow = true;
    this._scene.add(Wall55);
    
    const Wall556 = new THREE.Mesh(
      new THREE.BoxGeometry(10, 200, 10),
      new THREE.MeshStandardMaterial({
          color: 0x0000FF,
      }));
    Wall556.position.set(5, 100, -250);
    Wall556.castShadow = true;
    Wall556.receiveShadow = true;
    this._scene.add(Wall556);

    const Wall557 = new THREE.Mesh(
      new THREE.BoxGeometry(10, 200, 10),
      new THREE.MeshStandardMaterial({
          color: 0xFFFF00,
      }));
    Wall557.position.set(5, -100, 250);
    Wall557.castShadow = true;
    Wall557.receiveShadow = true;
    this._scene.add(Wall557);

    const Wall558 = new THREE.Mesh(
      new THREE.BoxGeometry(10, 200, 10),
      new THREE.MeshStandardMaterial({
          color: 0x800080,
      }));
    Wall558.position.set(5, -100, -250);
    Wall558.castShadow = true;
    Wall558.receiveShadow = true;
    this._scene.add(Wall558);
